...
1. 先搜索 [Issues](https://github.com/MINGCHOW/intelligent-stock-decision/issues) 确认问题未被报告
...
查看项目 [README](README.md) 了解当前需要的功能：
...
# 单独测试
python test_env.py --config    # 查看配置
python test_env.py --db        # 查看数据库
python test_env.py --fetch     # 测试数据获取
python test_env.py --llm       # 测试 LLM
python test_env.py --notify    # 测试通知
```
